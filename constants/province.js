/**
 * Created by yixi on 12/10/15.
 */
import _ from 'lodash';

let zone = [
    {name: '北京市', code: 110000, cities: [{name: '全部', code: 110000}]},
    {name: '天津市', code: 120000, cities: [{name: '全部', code: 120000}]},
    {
        name: '河北省', code: 130000, cities: [{name: '全部', code: 130000},
    ...
    {
        name: '山西省', code: 140000, cities: [{name: '全部', code: 140000},
    ...
    {
        name: '内蒙古自治区', code: 150000, cities: [{name: '全部', code: 150000},
    ...
    {
        name: '辽宁省', code: 210000, cities: [{name: '全部', code: 210000},
    ...
    {
        name: '吉林省', code: 220000, cities: [{name: '全部', code: 220000},
    ...
    {
        name: '黑龙江省', code: 230000, cities: [{name: '全部', code: 230000},
    ...
    {name: '上海市', code: 310000, cities: [{name: '全部', code: 310000}]},
    {
        name: '江苏省', code: 320000, cities: [{name: '全部', code: 320000},
    ...
    {
        name: '浙江省', code: 330000, cities: [{name: '全部', code: 330000},
    ...
    {
        name: '安徽省', code: 340000, cities: [{name: '全部', code: 340000},
    ...
    {
        name: '福建省', code: 350000, cities: [{name: '全部', code: 350000},
    ...
    {
        name: '江西省', code: 360000, cities: [{name: '全部', code: 360000},
    ...
    {
        name: '山东省', code: 370000, cities: [{name: '全部', code: 370000},
    ...
    {
        name: '河南省', code: 410000, cities: [{name: '全部', code: 410000},
    ...
    {
        name: '湖北省', code: 420000, cities: [{name: '全部', code: 420000},
    ...
    {
        name: '湖南省', code: 430000, cities: [{name: '全部', code: 430000},
    ...
    {
        name: '广东省', code: 440000, cities: [{name: '全部', code: 440000},
    ...
    {
        name: '广西壮族自治区', code: 450000, cities: [{name: '全部', code: 450000},
    ...
    {
        name: '海南省', code: 460000, cities: [{name: '全部', code: 460000},
    ...
    {name: '重庆市', code: 500000, cities: [{name: '全部', code: 500000}]},
    {
        name: '四川省', code: 510000, cities: [{name: '全部', code: 510000},
    ...
    {
        name: '贵州省', code: 520000, cities: [{name: '全部', code: 520000},
    ...
    {
        name: '云南省', code: 530000, cities: [{name: '全部', code: 530000},
    ...
    {
        name: '西藏自治区', code: 540000, cities: [{name: '全部', code: 540000},
    ...
    {
        name: '陕西省', code: 610000, cities: [{name: '全部', code: 610000},
    ...
    {
        name: '甘肃省', code: 620000, cities: [{name: '全部', code: 620000},
    ...
    {
        name: '青海省', code: 630000, cities: [{name: '全部', code: 630000},
    ...
    {
        name: '宁夏回族自治区', code: 640000, cities: [{name: '全部', code: 640000},
    ...
    {
        name: '新疆维吾尔自治区', code: 650000, cities: [{name: '全部', code: 650000},
    ...
    {name: '台湾省', code: 710000, cities: [{name: '全部', code: 710000}]},
    {name: '香港特别行政区', code: 810000, cities: [{name: '全部', code: 810000}]},
    {name: '澳门特别行政区', code: 820000, cities: [{name: '全部', code: 820000}]}];
...
_.forEach(zone, (province) => {
    hashWithName[province.name] = province;
    hashWithCode[province.code] = province;
    _.forEach(province.cities, (city) => {
        if (city.name !== '全部') {
            hashWithName[city.name] = city;
            hashWithCode[city.code] = city;
        }
    });
});

let getDataFromName = (name) => hashWithName[name];
let getDataFromCode = (code) => {
    if (code === '000000') {
        ...
        console.log(hashWithCode[code]);
        return hashWithCode[code];
    }
};
let getProvinceFromCity = (cityName) => {
    let cityCode = getDataFromName(cityName).code;
    let ProvinceCode = Math.floor(cityCode / 10000) * 10000;
    return getDataFromCode(ProvinceCode).name;
};

let getSelectorFormatZones = () => {
    return zone.map(province => {
        let sp = {
            id: province.code,
            text: province.name.replace(/[市省]$/, '')
        };
        if (province.cities) {
            sp.datas = province.cities.map(city => ({id: city.code, text: city.name.replace(/[市省]$/, '')}));
        }
        return sp;
    });
};

let getVisitorPermissionSelectorZones = () => {
    let ret = zone.map(province => {
        let p = {
            value: province.code,
            label: province.name
        };

        p.children = province.cities.map((c) => {
            return {
                value: c.code,
                label: c.name
            }
        ...
        // 不在直辖市中的数据就去除第一个选项
        if ([110000, 120000, 310000, 500000, 710000, 810000, 820000].indexOf(p.value) < 0) {
             p.children.shift();
        }
        return p;
    });
...
export {zone, getDataFromCode, getDataFromName, getProvinceFromCity, getSelectorFormatZones, getVisitorPermissionSelectorZones};
